    ...
    class << self
      ...
      def fishing_materials
        [
          ...
          FishingMaterialData::MAINTENANCE_MEK_INITIAL_CONFIGURATION,
          FishingMaterialData::MAINTENANCE_MEK_PLATINUM_COLLECTION,
          FishingMaterialData::MAINTENANCE_MEK_SITUATION_CONTROLLER,
          FishingMaterialData::MAINTENANCE_MEK_WATER_BODY_CLEANER,
