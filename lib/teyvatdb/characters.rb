module TeyvatDB
  module Characters
    ...
    KAEDEHARA_KAZUHA = Character.new(
    ...
    SANGONOMIYA_KOKOMI = Character.new(
    ...
    SHIKANOIN_HEIZOU = Character.new(
    ...
    # WRIOTHESLEY = Character.new().freeze

    XIANGLING = Character.new(
